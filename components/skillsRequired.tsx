...
const SkillsRequired = () => {
  return (
    <div className='py-8 pl-[100px] flex gap-x-16 border-t border-[#e7e7e7]'>
        {/* section 1 */}
        <div className='flex-col'>
            <p className='font-medium text-[#6E6D6D]'>Skills Requiried</p>
        ...
        <div className='flex-col gap-y-2'>
            <p className='text-sm font-medium text-[#6E6D6D]'>Prefered language</p>
